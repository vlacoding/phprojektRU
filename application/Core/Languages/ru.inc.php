...
$lang["Administration"] = "Администрирование";
  // Messages
$lang["Admin section is only for admin users"] = "Этот раздел только для администраторов";
  // View
$lang["This module is for the user to set and change specific configuration parameters of his/her profile."] = "Этот "
    . "модуль для настройки вашего пользовательского профиля.";
$lang["Here can be configured general settings of the site that affects all the users."] = "Здесь могут быть изменениы "
    . "общие настройки движка, которые затронут всех пользователей.";
$lang["Please choose one of the tabs of above."] = "Выберите одну из вкладок выше.";

// User
  // System
$lang["User"] = "Пользователь";
  // Fields
$lang["Confirm Password"] = "Подтверждение пароля";
...
$lang["You need to log out and log in again in order to let changes have effect"] = "Выйдите из аккаунта и войдите "
    . "снова, чтобы изменения вступили в силу.";
  // Tooltip Help
...
$lang["Global"] = "Общий";
$lang["Open Editor"] = "Открыть редактор";
  // Tooltip help
$lang["Open a dialog where you can drag and drop many fields for create the form as you want."] = "Открывает окно, где "
    . "вы можете настроить поля формы в визуальном редакторе при помощи перетаскивания.";
  // Module Designer
    // Fields
$lang["Database"] = "База данных";
$lang["Field name"] = "Название поля";
$lang["Field type"] = "Тип поля";
$lang["Field lenght"] = "Длина поля";
$lang["Select Type"] = "Выбрать тип";
$lang["Custom Values"] = "Кастомные значения";
$lang["Values"] = "Значения";
$lang["Default Value"] = "Стандартное значение";
$lang["Grid"] = "Разметка";
$lang["List Position"] = "Положение в списке";
$lang["General"] = "Общее";
$lang["Required Field"] = "Обязательное поле";
    // Messages
      // System
...
$lang["Tab"] = "Вкладка";
  // Labels
$lang["Basic Data"] = "Основная информация";
$lang["People"] = "Люди";
...
$lang["Company Name"] = "Название организации";
  // Messages
$lang["The Company name is empty"] = "название организации не указано";

// Notification
  // Fields
$lang["Login / Logout"] = "Войти / Выйти";
$lang["Data Records"] = "Записи данных";
$lang["Alerts"] = "Оповещения";
  // System
$lang["Notification"] = "Уведомления";
  // Tooltip Help
$lang["Tooltip"]["alerts"] = "Вкл/выкл оповещения, н-р, о начале мероприятия.";
$lang["Tooltip"]["loginLogout"] = "Вкл/выкл оповещения о входе/выходе"
    . " пользователей.";
$lang["Tooltip"]["usergenerated"] = "Вкл/выкл оповещения от других пользователей, адресованые вам.";
$lang["Tooltip"]["datarecords"] = "Вкл/выкл системные оповещения.<br />"
    . "События: СОЗДАНИЕ a new Item (e.g. a Project, Note or Todo), УДАЛЕНИЕ an existing Item, "
    . "and РЕДАКТИРОВАНИЕ an Item.";
