...
$lang["Current status"] = "Статус";
$lang["Offered"] = "Предложено";
$lang["Ordered"] = "Планируется";
$lang["Working"] = "В работе";
$lang["Ended"] = "Завершено";
$lang["Stopped"] = "Остановлено";
$lang["Re-Opened"] = "Перезапущено";
$lang["Waiting"] = "Ожидает";
$lang["Complete percent"] = "Процент выполнения";
$lang["Budget"] = "Бюджет";
$lang["Hourly wage rate"] = "Ставка, руб/час";
$lang["Contact"] = "Контакт";

// Messages
  // View
$lang["The deletion of a project and its subprojects might take a while"] = "Удаление проекта и его "
    . "подпроектов может занять некоторое время";

// Tooltip Help
$lang["Tooltip"]["projectId"] = "Родительский проект (если нет, выберите МК РГО)";
